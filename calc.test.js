...
test('1. Personbil', () => {
  ...
  expect(run(1,2, "08-12-2021", 499, true).map(t=>[t.compensationFee, t.weightTax, t.total])).toEqual([ [5020,8580, 13600], [5020, 8840, 13860], [5020,9420,14440 ], [5020,10030,15050 ], [5020,10680, 15700], [5020,11750, 16770] ]);
